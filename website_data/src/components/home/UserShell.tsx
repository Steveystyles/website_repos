    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <div className="flex min-h-screen flex-col">
        <main className="flex-1 px-4 py-6 sm:px-8 lg:px-12">
          <section className="mx-auto flex w-full max-w-4xl flex-col gap-6 rounded-2xl border border-slate-800/80 bg-slate-900/40 p-6 shadow-lg sm:p-8">
            <header className="flex flex-col gap-3 border-b border-slate-800/80 pb-6">
